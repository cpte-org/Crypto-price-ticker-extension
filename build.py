...
#Coins names
coinName = ["ethereum","ethereum-classic","bitcoin-cash","bitcoin-cash-sv","bitcoin","litecoin","zcash","neo","cardano","monero","thorchain","dogecoin","haven","ethereum-name-service","terra-luna"]
coinSuffix = ["ETH","ETC","BCH","BSV","BTC","LTC","ZEC","NEO","ADA","XMR","RUNE","DOGE","XHV","ENS","LUNA"]
